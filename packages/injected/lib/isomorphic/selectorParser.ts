...
import { InvalidSelectorError, parseCSS, type CSSComplexSelectorList } from './cssParser';
...
export interface AttributeSelectorPart {
  ...
  value: string | number | boolean | null | RegExp | undefined;
...
export function parseAttributeSelector(
  ...
  function readRegularExpression() {
    ...
    try {
      ...
      throw new InvalidSelectorError(
        `Error while parsing selector \`${selector}\`: ${errorMessage}`,
      );
    }
  }
  ...
  function readAttribute(): AttributeSelectorPart {
    ...
    let value: string | number | boolean | null | RegExp | undefined = undefined;
