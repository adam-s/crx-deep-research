...
export interface LocalUtilsChannel extends LocalUtilsEventTarget, Channel {
  ...
  globToRegex(
    params: LocalUtilsGlobToRegexParams,
    progress?: Progress,
  ): Promise<LocalUtilsGlobToRegexResult>;
}
...
export interface DebugControllerEventTarget {
  ...
  on(
    event: 'setModeRequested',
    callback: (params: DebugControllerSetModeRequestedEvent) => void,
  ): this;
...
export interface BrowserChannel extends BrowserEventTarget, Channel {
  ...
  disconnectFromReusedContext(
    params: BrowserDisconnectFromReusedContextParams,
    progress?: Progress,
  ): Promise<BrowserDisconnectFromReusedContextResult>;
...
export interface BrowserContextChannel extends BrowserContextEventTarget, EventTargetChannel {
  ...
  registerSelectorEngine(
    params: BrowserContextRegisterSelectorEngineParams,
    progress?: Progress,
  ): Promise<BrowserContextRegisterSelectorEngineResult>;
  setTestIdAttributeName(
    params: BrowserContextSetTestIdAttributeNameParams,
    progress?: Progress,
  ): Promise<BrowserContextSetTestIdAttributeNameResult>;
  setExtraHTTPHeaders(
  ...
  disableRecorder(
    params?: BrowserContextDisableRecorderParams,
    progress?: Progress,
  ): Promise<BrowserContextDisableRecorderResult>;
  newCDPSession(
...
export interface PageEventTarget {
  ...
  on(
    event: 'locatorHandlerTriggered',
    callback: (params: PageLocatorHandlerTriggeredEvent) => void,
  ): this;
...
export interface PageChannel extends PageEventTarget, EventTargetChannel {
  ...
  snapshotForAI(
    params?: PageSnapshotForAIParams,
    progress?: Progress,
  ): Promise<PageSnapshotForAIResult>;
  startJSCoverage(
...
export interface FrameChannel extends FrameEventTarget, Channel {
  ...
  ariaSnapshot(
    params: FrameAriaSnapshotParams,
    progress?: Progress,
  ): Promise<FrameAriaSnapshotResult>;
  ...
  generateLocatorString(
    params: FrameGenerateLocatorStringParams,
    progress?: Progress,
  ): Promise<FrameGenerateLocatorStringResult>;
...
export interface WebSocketRouteEventTarget {
  on(
    ...
    callback: (params: WebSocketRouteMessageFromPageEvent) => void,
  ): this;
  on(
    event: 'messageFromServer',
    callback: (params: WebSocketRouteMessageFromServerEvent) => void,
  ): this;
...
export interface WebSocketRouteChannel extends WebSocketRouteEventTarget, Channel {
  ...
  connect(
    params?: WebSocketRouteConnectParams,
    progress?: Progress,
  ): Promise<WebSocketRouteConnectResult>;
  ensureOpened(
    params?: WebSocketRouteEnsureOpenedParams,
    progress?: Progress,
  ): Promise<WebSocketRouteEnsureOpenedResult>;
  sendToPage(
    params: WebSocketRouteSendToPageParams,
    progress?: Progress,
  ): Promise<WebSocketRouteSendToPageResult>;
  sendToServer(
    params: WebSocketRouteSendToServerParams,
    progress?: Progress,
  ): Promise<WebSocketRouteSendToServerResult>;
  closePage(
    params: WebSocketRouteClosePageParams,
    progress?: Progress,
  ): Promise<WebSocketRouteClosePageResult>;
  closeServer(
...
export interface TracingChannel extends TracingEventTarget, Channel {
  ...
  tracingGroup(
    params: TracingTracingGroupParams,
    progress?: Progress,
  ): Promise<TracingTracingGroupResult>;
  tracingGroupEnd(
    params?: TracingTracingGroupEndParams,
    progress?: Progress,
  ): Promise<TracingTracingGroupEndResult>;
  tracingStopChunk(
