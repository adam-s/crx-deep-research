 ...
 * Second, due to framework differences we need to get our script content as a string
 * to avoid pathing issues due to file routing in frameworks like Next.js
 ...
 *
 * We can't rely on the normal build process for stagehand,
 * because we need our script content as a string so that the import *just works*
 */
import fs from 'fs';
