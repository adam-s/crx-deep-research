...
export class StagehandObserveHandler {
  ...
  public async observe({
    ...
    const { combinedTree, combinedXpathMap, discoveredIframes } = await (iframes
      ? getAccessibilityTreeWithFrames(this.experimental, this.stagehandPage, this.logger).then(
      ...
      : getAccessibilityTree(this.experimental, this.stagehandPage, this.logger).then(
