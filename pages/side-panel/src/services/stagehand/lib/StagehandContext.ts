...
export class StagehandContext {
  ...
  private async attachFrameNavigatedListener(pwPage: PlaywrightPage): Promise<void> {
    ...
    session.on('Page.frameNavigated', (evt: Protocol.Page.FrameNavigatedEvent): void => {
