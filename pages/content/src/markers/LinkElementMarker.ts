...
/**
 * Link-specific element marker - captures only link and icon-link elements
 * Implements logic from marking_links.js
 */
export class LinkElementMarker extends BaseElementMarker {
